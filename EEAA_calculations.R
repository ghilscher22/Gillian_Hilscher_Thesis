...
# Load G954 RGChannelSetExtended
...
# Create dataframe with sample id and Visit 2 PhenoAge epigenetic age 
# acceleration ENmix values
Visit3_EEAAPhenoAge <- EEAA.ENmix[EEAA.ENmix$Visit==3,c("Subject.ID",
                                                        "EEAAPhenoAge.ENmix")]
names(Visit3_EEAAPhenoAge)[2]<-"Visit3_EEAAPhenoAge"
# Delete rows by name (delete those on blockers)
Visit2_EEAAPhenoAge <- Visit2_EEAAPhenoAge[!(row.names(Visit2_EEAAPhenoAge) %in% 
                                                 c("2","16","17")),]
# Perform Shaprio test to see distribution
shapiro.test(x=c(Visit2_EEAAPhenoAge$Visit2_EEAAPhenoAge,
                 Visit3_EEAAPhenoAge$Visit3_EEAAPhenoAge)) 
...
Visit3_EEAAPhenoAge <- EEAA.ENmix[EEAA.ENmix$Visit==3,c("Subject.ID",
                                                        "EEAAPhenoAge.ENmix")]
names(Visit3_EEAAPhenoAge)[2]<-"Visit3_EEAAPhenoAge"
# Delete rows by name (delete those on blockers or assigned male at birth)
Visit2_EEAAPhenoAge <- Visit2_EEAAPhenoAge[!(row.names(Visit2_EEAAPhenoAge) %in% 
                                                 c("2","12","16","17","22","32")),]
# Delete rows by name (delete those assigned male at birth)
Visit3_EEAAPhenoAge <- Visit3_EEAAPhenoAge[!(row.names(Visit3_EEAAPhenoAge) %in% 
                                             c("33")),]
# Perform Shaprio test to see distribution
shapiro.test(x=c(Visit2_EEAAPhenoAge$Visit2_EEAAPhenoAge,
                 Visit3_EEAAPhenoAge$Visit3_EEAAPhenoAge)) 
